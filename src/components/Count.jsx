...
export default function Count({icon , title , text}) {
  return (
    <div className="bg-[#512051] w-[20.4375rem] h-[15.5rem] m-6 p-6 text-white rounded-lg">
      ...
      <h2 className="text-[#EE69A4] font-normal text-[ 1.0625rem]">Verified Buyer</h2>
      </div>
      </div>
      <p className="text-[1.0625rem] font-medium leading-[1.375rem] tracking-[-0.019rem] pt-6 px-[0.7rem]">{text}</p>
    </div>
  );
}
